...
#define FT_INT    			 	gpio_input_bit_get(GPIOB,GPIO_PIN_1)   /* FT5206中断引脚	 */

/* IIC读写命令 */	
#define FT_CMD_WR 				     0X70       /* 写命令(最低位为0) */
#define FT_CMD_RD 				     0X71		    /* 读命令(最低位为1) */
...
uint8_t ft5206_scan(uint8_t mode);                               /* 触摸屏扫描函数 */
